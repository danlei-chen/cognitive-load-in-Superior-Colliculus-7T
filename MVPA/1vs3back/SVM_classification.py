...
@author: chendanlei
"""
################# BELOW ARE DECODING SCRIPT COPIED BECAUSE CLUSTER HAS A PROBLEM OF IMPORTING DECODER #################
################# https://github.com/nilearn/nilearn/blob/master/nilearn/decoding/decoder.py #################
...
################# END OF DECODING SCRIPT COPIED BECAUSE CLUSTER HAS A PROBLEM OF IMPORTING DECODER #################
################# https://github.com/nilearn/nilearn/blob/master/nilearn/decoding/decoder.py #################
...
cope_files2 = glob.glob('/scratch/data/'+proj+'/SC_warp/3_USneu_cope/warped_files/*cope3.nii.gz')
