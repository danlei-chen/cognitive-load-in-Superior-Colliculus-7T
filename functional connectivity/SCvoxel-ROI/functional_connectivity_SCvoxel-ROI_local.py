...
roi_dir_base = '/Volumes/GoogleDrive/My Drive/U01/working_memory/analysis/connectivity/roi/'
...
output_dir_base = '/Volumes/GoogleDrive/My Drive/U01/working_memory/analysis/connectivity/results/fc_results2/'
os.makedirs(output_dir_base, exist_ok = True)
input_dir = '/Volumes/GoogleDrive/My Drive/U01/working_memory/analysis/connectivity/data/res4d_SC_warp/wm_nback_block/'
subj_list = [i.split('/')[-1] for i in glob.glob(input_dir+'*')]
# subj_list=subj_list[0:1]
subj_list.sort()
print(subj_list)
print(len(subj_list))

confound_file_dir = '/Volumes/GoogleDrive/My Drive/U01/working_memory/data/confound_files/'
event_file_dir = '/Volumes/GoogleDrive/My Drive/U01/working_memory/data/event_files/'
    ...
    for hemi in hemispheres:
        ...
        for smooth in smooth_mm_list:
            ...
            for subj in subj_list:
                ...
                #get res4d file 
                res4d_img = nib.load(glob.glob(input_dir+subj+'/w_*res4d.nii.gz')[0])
                ...
                for location_coordinate in search_location_size:
                    ...
                    #get block condition 
                    subj_df_event = pd.read_csv(glob.glob(event_file_dir+subj+'*.tsv')[0], sep='\t', header=0)
                    subj_df_confound = pd.read_csv(glob.glob(confound_file_dir+subj+'*.tsv')[0], sep='\t', header=0)
