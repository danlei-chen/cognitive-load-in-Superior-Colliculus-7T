...
# subj_df_event = pd.read_table('/Volumes/GoogleDrive/My Drive/U01/working_memory/data/event_files/sub-042_task-wm_events.tsv', sep='\t')
event_dir = glob.glob('/scratch/data/'+subj+'/func/'+'*_task-wm_events.tsv')[0]
subj_df_event = pd.read_table(event_dir, sep='\t')

subj_df_event['Response'] = pd.to_numeric(subj_df_event['Response'])
subj_df_event['Correct'] = pd.to_numeric(subj_df_event['Correct'])
subj_df_event.loc[((subj_df_event['Response']!=0) & (subj_df_event['Correct']==1)), 'trial_type'] = 'correct_motion'
subj_df_event.loc[((subj_df_event['Response']!=0) & (subj_df_event['Correct']==0)), 'trial_type'] = 'incorrect_motion'
subj_df_event.loc[((subj_df_event['Response']==0) & (subj_df_event['Correct']==1)), 'trial_type'] = 'correct_no_motion'
subj_df_event.loc[((subj_df_event['Response']==0) & (subj_df_event['Correct']==0)), 'trial_type'] = 'incorrect_no_motion'
...
subj_df_event.to_csv(os.path.join('/scratch/wrkdir/',subj+'_wm_events_'+os.environ['PROJNAME']+'.tsv'),index=True,sep='\t')
...
# no incorrect_motion: 013, 032, 044, 059, 084
if subj in ['sub-013', 'sub-032', 'sub-044', 'sub-059', 'sub-084']:
    model_wf.inputs.inputspec.conditions = ['correct_motion', 'correct_no_motion', 'incorrect_no_motion', ['correct_motion','RT', 'cent', 'norm']] # parameter to model from task file.
    model_wf.inputs.inputspec.contrasts = [['correct_motion', 'T', ['correct_motion'], [1]],
                                           ['correct_no_motion', 'T', ['correct_no_motion'], [1]],
                                           ['incorrect_no_motion', 'T', ['incorrect_no_motion'], [1]],
                                           ['correct_motion_RT', 'T', ['correct_motion_RT'], [1]],
                                           ['correct_vs_incorrect_no_motion', 'T', ['correct_no_motion', 'incorrect_no_motion'], [1,-1]],
                                           ['correct_motion_vs_no_motion', 'T', ['correct_motion', 'correct_no_motion'], [1,-1]]]
# no incorrect_no_motion: 024, 105, 112
elif subj in ['sub-024', 'sub-105', 'sub-112']:
    model_wf.inputs.inputspec.conditions = ['correct_motion', 'incorrect_motion', 'correct_no_motion', ['correct_motion','RT', 'cent', 'norm']] # parameter to model from task file.
    model_wf.inputs.inputspec.contrasts = [['correct_motion', 'T', ['correct_motion'], [1]],
                                           ['incorrect_motion', 'T', ['incorrect_motion'], [1]],
                                           ['correct_no_motion', 'T', ['correct_no_motion'], [1]],
                                           ['correct_motion_RT', 'T', ['correct_motion_RT'], [1]],
                                           ['correct_vs_incorrect_motion', 'T', ['correct_motion', 'incorrect_motion'], [1,-1]],
                                           ['correct_motion_vs_no_motion', 'T', ['correct_motion', 'correct_no_motion'], [1,-1]]]
elif subj in ['sub-088']:
    model_wf.inputs.inputspec.conditions = ['correct_motion', 'correct_no_motion', ['correct_motion','RT', 'cent', 'norm']] # parameter to model from task file.
    model_wf.inputs.inputspec.contrasts = [['correct_motion', 'T', ['correct_motion'], [1]],
                                           ['correct_no_motion', 'T', ['correct_no_motion'], [1]],
                                           ['correct_motion_RT', 'T', ['correct_motion_RT'], [1]],
                                           ['correct_motion_vs_no_motion', 'T', ['correct_motion', 'correct_no_motion'], [1,-1]]]
else:
    model_wf.inputs.inputspec.conditions = ['correct_motion', 'incorrect_motion', 'correct_no_motion', 'incorrect_no_motion', ['correct_motion','RT', 'cent', 'norm']] # parameter to model from task file.
    model_wf.inputs.inputspec.contrasts = [['correct_motion', 'T', ['correct_motion'], [1]],
                                           ['incorrect_motion', 'T', ['incorrect_motion'], [1]],
                                           ['correct_no_motion', 'T', ['correct_no_motion'], [1]],
                                           ['incorrect_no_motion', 'T', ['incorrect_no_motion'], [1]],
...
model_wf.inputs.inputspec.bold_template = {'bold': '/scratch/data/'+subj+'/func/'+'*_task-wm_bold_space-MNI152NLin2009cAsym_preproc.nii.gz'}
model_wf.inputs.inputspec.mask_template = {'mask': '/scratch/data/'+subj+'/func/'+'*_task-wm_bold_space-MNI152NLin2009cAsym_brainmask.nii.gz'}
model_wf.inputs.inputspec.task_template = {'task': '/scratch/wrkdir/'+subj+'_wm_events_'+os.environ['PROJNAME']+'.tsv'}
# model_wf.inputs.inputspec.confound_template = {'confound': '/scratch/data/'+subj+'/func/'+subj+'_task-wm_bold_confounds.tsv'} 
model_wf.inputs.inputspec.confound_template = {'confound': '/scratch/data/aCompCor/'+subj+'/'+'*_task-wm_bold_confounds.tsv'} 
model_wf.inputs.inputspec.smooth_gm_mask_template = {'gm_mask': '/scratch/data/'+subj+'/anat/'+'*_T1w_space-MNI152NLin2009cAsym_class-GM_probtissue.nii.gz'}
...
full_model_wf.base_dir = '/scratch/wrkdir/'+os.environ['PROJNAME']
