...
# subj_list1 = [i[0:7] for i in subj_list if i[-1]=='b']
# subj_list2 = [i for i in subj_list if i[-1]!='b']
# subj_list = subj_list1+subj_list2
# print(subj_list)
...
def setup_DARTEL_warp_wf(subj_list, data_template, warp_template, work_dir, out_dir):
    ...
    ##########################
    inputspec.inputs.warp_list = [i for i in inputspec.inputs.warp_list if i.split('/')[-1].split('u_SC_combined_Wager_atlas_edited_')[-1].split('_wm')[0] in subj_list]
    ##########################
...
# subj_list = os.environ.get("SUBJ_LIST").split(" ")
subj_list = [i.split('/')[-1] for i in glob.glob('/scratch/data/*')]
subj_list1 = [i[0:7] for i in subj_list if i[-1]=='b']
subj_list2 = [i for i in subj_list if i[-1]!='b']
subj_list = subj_list1+subj_list2
subj_list.sort()
print(subj_list)
print(len(subj_list))
subj_existed = [i.split('/')[-1].split('w_')[-1].split('__')[0] for i in glob.glob('/scratch/output/8_correct_motion_vs_no_motion/warped_files/*')]
...
for s in subj_list:
	...
	# no incorrect_motion: 013, 032, 059, 084, 044
	if s in ['sub-013', 'sub-032', 'sub-044', 'sub-059', 'sub-084']:
		print('renaming')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz','/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz','/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz','/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz','/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2.nii.gz','/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2_orig.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope8.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope7.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz')
		data_templates = {'1_correct_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz',
						  '3_correct_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz',
						  '4_incorrect_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz',
						  '5_correct_motion_RT': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz',
						  '7_correct_vs_incorrect_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope7.nii.gz',
						  '8_correct_motion_vs_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope8.nii.gz'}
	# no incorrect_no_motion: 024, 105, 112
	elif s in ['sub-024', 'sub-105', 'sub-112']:
		print('renaming')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4_orig.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope8.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz')
		data_templates = {'1_correct_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz',
						  '2_incorrect_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2.nii.gz',
						  '3_correct_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz',
						  '5_correct_motion_RT': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz',
						  '6_correct_vs_incorrect_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope6.nii.gz',
						  '8_correct_motion_vs_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope8.nii.gz'}
	elif s in ['sub-088']:
		print('renaming')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3_orig.nii.gz')
		# shutil.copyfile('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2_orig.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope4.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope8.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz')
		# os.rename('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope2.nii.gz', '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz')
		data_templates = {'1_correct_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz',
						  '3_correct_no_motion': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope3.nii.gz',
						  '5_correct_motion_RT': '/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope5.nii.gz',
	...
	work_dir = '/scratch/wrkdir'
	out_dir = '/scratch/output'
	# for f in glob.glob(os.path.join('/scratch/dartel_flow', 'u_SC*sub-*_Template.nii')):
	# 	print('resampling')
	# 	f_resample = resample_img(nib.load(f),
	# 	        target_affine=nib.load(glob.glob('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz')[0]).affine,
	# 	        target_shape=nib.load(glob.glob('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz')[0]).shape[0:3],
	# 	        interpolation='nearest').get_fdata()
	# 	# f_resample = f_resample[:,:,:,0,0]
	# 	f_resample = nib.Nifti1Image(f_resample, nib.load(glob.glob('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz')[0]).affine, nib.load(glob.glob('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz')[0]).header)
	# 	print(f_resample.shape)
	# 	print(nib.load(glob.glob('/scratch/data/'+s+'/model/_'+s+'/_modelestimate0/cope1.nii.gz')[0]).shape)
	# 	nib.save(f_resample, f.split('.nii')[0]+'_resampled.nii')
	warp_template = os.path.join('/scratch/dartel_flow', 'u_SC*'+s+'*_Template_resampled.nii')
	# subj_list = [i.split('u_SC_combined_Wager_atlas_edited_')[-1].split('_wm')[0] for i in glob.glob(warp_template)]
	# subj_list.sort()
	# print(len(subj_list))
...
# files = glob.glob('/scratch/output/3_1vs3back_cope/warped_files/*.nii.gz')
# print(files)
# for f in files:
#     print(f)
#     new = nib.load(f).get_fdata()*(-1)
#     nib.save(nib.Nifti1Image(new, nib.load(f).affine, nib.load(f).header), f.split('3_1vs3back_cope')[0]+'3_3vs1back_cope/'+f.split('3_1vs3back_cope')[-1])
