...
print(subj_list)
print(len(subj_list))
subj_existed = [i.split('/')[-1].split('w_')[-1].split('__')[0] for i in glob.glob('/scratch/output/12_one_back_b6_cope/warped_files/*')]
subj_list = [i for i in subj_list if i not in subj_existed]
subj_list = ['sub-069', 'sub-080']
print(subj_list)
print(len(subj_list))

#for 069 and 080
data_templates = {'1_three_back_b1_cope': '/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz',
				  '2_three_back_b2_cope': '/scratch/data/*/model/_*/_modelestimate0/cope2.nii.gz',
				  '3_three_back_b3_cope': '/scratch/data/*/model/_*/_modelestimate0/cope3.nii.gz',
				  '7_one_back_b1_cope': '/scratch/data/*/model/_*/_modelestimate0/cope4.nii.gz',
				  '8_one_back_b2_cope': '/scratch/data/*/model/_*/_modelestimate0/cope5.nii.gz',
				  '9_one_back_b3_cope': '/scratch/data/*/model/_*/_modelestimate0/cope6.nii.gz'}
# data_templates = {'1_three_back_b1_cope': '/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz',
# 				  '2_three_back_b2_cope': '/scratch/data/*/model/_*/_modelestimate0/cope2.nii.gz',
# 				  '3_three_back_b3_cope': '/scratch/data/*/model/_*/_modelestimate0/cope3.nii.gz',
# 				  '4_three_back_b4_cope': '/scratch/data/*/model/_*/_modelestimate0/cope4.nii.gz',
# 				  '5_three_back_b5_cope': '/scratch/data/*/model/_*/_modelestimate0/cope5.nii.gz',
# 				  '6_three_back_b6_cope': '/scratch/data/*/model/_*/_modelestimate0/cope6.nii.gz',
# 				  '7_one_back_b1_cope': '/scratch/data/*/model/_*/_modelestimate0/cope7.nii.gz',
# 				  '8_one_back_b2_cope': '/scratch/data/*/model/_*/_modelestimate0/cope8.nii.gz',
# 				  '9_one_back_b3_cope': '/scratch/data/*/model/_*/_modelestimate0/cope9.nii.gz',
# 				  '10_one_back_b4_cope': '/scratch/data/*/model/_*/_modelestimate0/cope10.nii.gz',
# 				  '11_one_back_b5_cope': '/scratch/data/*/model/_*/_modelestimate0/cope11.nii.gz',
# 				  '12_one_back_b6_cope': '/scratch/data/*/model/_*/_modelestimate0/cope12.nii.gz'}
work_dir = '/scratch/wrkdir'
out_dir = '/scratch/output'
# for f in glob.glob(os.path.join('/scratch/dartel_flow', 'u_SC*sub-*_Template.nii')):
# 	print('resampling')
# 	f_resample = resample_img(nib.load(f),
# 	        target_affine=nib.load(glob.glob('/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz')[0]).affine,
# 	        target_shape=nib.load(glob.glob('/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz')[0]).shape[0:3],
# 	        interpolation='nearest').get_fdata()
# 	# f_resample = f_resample[:,:,:,0,0]
# 	f_resample = nib.Nifti1Image(f_resample, nib.load(glob.glob('/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz')[0]).affine, nib.load(glob.glob('/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz')[0]).header)
# 	print(f_resample.shape)
# 	print(nib.load(glob.glob('/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz')[0]).shape)
# 	nib.save(f_resample, f.split('.nii')[0]+'_resampled.nii')
warp_template = os.path.join('/scratch/dartel_flow', 'u_SC*sub-*_Template_resampled.nii')
