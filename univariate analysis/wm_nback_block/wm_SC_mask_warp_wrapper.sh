...
# set SUBJ_LIST=`ls $DATA/nosmooth`
# set SUBJ_LIST = `echo $SUBJ_LIST | fmt -1 | sort -n`
...
# rsync -ra /autofs/cluster/iaslab_7T/FSMAP/FSMAP_data/BIDS_modeled/subject_SC_mask/emoAvd/no_resample/dartel_flow /scratch/$USER/$PROJNAME/wrkdir/
...
rsync $SCRIPTPATH/model/$PROJNAME/{wm_SC_mask_warp_startup.sh,wm_SC_mask_warp.py} /scratch/$USER/$PROJNAME/wrkdir/
chmod a+rwx /scratch/$USER/$PROJNAME/wrkdir/wm_SC_mask_warp_startup.sh
cd /scratch/$USER
...
mv $OUTPUT/SC_warp/7_one_back_b1_cope/warped_files/w_sub-080__modelestimate0_cope4.nii.gz $OUTPUT/SC_warp/7_one_back_b1_cope/warped_files/w_sub-080__modelestimate0_cope7.nii.gz

mv $OUTPUT/SC_warp/8_one_back_b2_cope/warped_files/w_sub-069__modelestimate0_cope5.nii.gz $OUTPUT/SC_warp/8_one_back_b2_cope/warped_files/w_sub-069__modelestimate0_cope8.nii.gz
mv $OUTPUT/SC_warp/8_one_back_b2_cope/warped_files/w_sub-080__modelestimate0_cope5.nii.gz $OUTPUT/SC_warp/8_one_back_b2_cope/warped_files/w_sub-080__modelestimate0_cope8.nii.gz

mv $OUTPUT/SC_warp/9_one_back_b3_cope/warped_files/w_sub-069__modelestimate0_cope6.nii.gz $OUTPUT/SC_warp/9_one_back_b3_cope/warped_files/w_sub-069__modelestimate0_cope9.nii.gz
mv $OUTPUT/SC_warp/9_one_back_b3_cope/warped_files/w_sub-080__modelestimate0_cope6.nii.gz $OUTPUT/SC_warp/9_one_back_b3_cope/warped_files/w_sub-080__modelestimate0_cope9.nii.gz
