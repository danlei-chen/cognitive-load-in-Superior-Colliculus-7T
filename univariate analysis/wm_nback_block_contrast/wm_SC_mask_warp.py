...
print(subj_list)
print(len(subj_list))
subj_existed = [i.split('/')[-1].split('w_')[-1].split('__')[0] for i in glob.glob('/scratch/output/3_three_one_back_block_contrast/warped_files/*')]
subj_list = [i for i in subj_list if i not in subj_existed]
print(subj_list)
print(len(subj_list))

data_templates = {'1_three_back_block': '/scratch/data/*/model/_*/_modelestimate0/cope1.nii.gz',
				  '2_one_back_block': '/scratch/data/*/model/_*/_modelestimate0/cope2.nii.gz',
				  '3_three_one_back_block_contrast': '/scratch/data/*/model/_*/_modelestimate0/cope3.nii.gz'}
work_dir = '/scratch/wrkdir'
out_dir = '/scratch/output'
